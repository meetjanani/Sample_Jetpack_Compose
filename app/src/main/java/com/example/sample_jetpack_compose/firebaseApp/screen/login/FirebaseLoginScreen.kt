...
import com.example.sample_jetpack_compose.compnent.EmailInput
import com.example.sample_jetpack_compose.compnent.FirebaseLogo
import com.example.sample_jetpack_compose.compnent.PasswordInput
...
fun FirebaseLoginScreen(navController: NavController,
                        viewModel: FirebaseLoginScreenViewModel = koinViewModel()) {
    ...
    Surface(
        ...
        Column(
            ...
            FirebaseLogo()
            if(showLoginForm.value) UserForm(loading = false,
        ...
        Row(
            ...
            val loginOrCreateText = if(showLoginForm.value) "Sign up" else "Login"
            Text(text = "New User?")
            Text(text = loginOrCreateText,
                modifier = Modifier
                    .clickable {
...
//        .height(260.dp)
    ...
    Column(
        ...
        if(isCreateAccount) Text(text = stringResource(id = R.string.create_account_string),
            modifier = Modifier.padding(12.dp)) else Text(text = "")
